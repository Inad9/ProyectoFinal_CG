...
bool recorrido1_1 = false;
bool recorrido1_2 = false;
bool recorrido1_3 = false;
bool recorrido1_4 = false;
...
void animacion()
{
		...
		{
			//	Si esta activo el primer recorrido (Parte 1) (En el eje Z y Y)
			if (recorrido1_1)
			{
				movPelZ += 0.1f;
				movPelY = -((movPelZ * movPelZ)) + (6*movPelZ);
				if (movPelZ > 6 && movPelY < 0)	//	La distancia máxima que puede recorrer en Z
				{
			...
			//	Si esta activo el primer recorrido (Parte 2) (En el eje Z y Y)
			if (recorrido1_2)
			{
				movPelZ += 0.07f;
				movPelY = -((movPelZ * movPelZ)) + (17*movPelZ) -66;
				if (movPelZ > 11 && movPelY < 0)	//	La distancia máxima que puede recorrer en Z
				{
					//	Se desactiva el primer recorrido y se activa el segundo
					recorrido1_2 = false;
					recorrido1_3 = true;
			...
			//	Si esta activo el primer recorrido (Parte 3) (En el eje Z y Y)
			if (recorrido1_3)
			{
				movPelZ += 0.05f;
				movPelY = -((movPelZ * movPelZ)) + (26*movPelZ)-165;
				if (movPelZ > 15 && movPelY < 0)	//	La distancia máxima que puede recorrer en Z
				{
					//	Se desactiva el primer recorrido y se activa el segundo
					recorrido1_3 = false;
					recorrido1_4 = true;
			...
			//	Si esta activo el primer recorrido (Parte 4) (En el eje Z y Y)
			if (recorrido1_4)
			{
				movPelZ += 0.03f;
				movPelY = -((movPelZ * movPelZ)) + (31.8 * movPelZ) - 252;
				if (movPelZ > 16.8 && movPelY < 0)	//	La distancia máxima que puede recorrer en Z
				{
					//	Se desactiva el primer recorrido y se activa el segundo
					recorrido1_4 = false;
					recorrido2 = true;
			...
			if (recorrido2)
			{
				//	Va cambiando el valor de Z y ese valor de Z se evalua la ecuacion 
				// -(X^2/6.2)+(2.5*x)+18 que nos dara el valor de Y
				movPelZ -= 0.1f;
				movPelY = -((movPelZ* movPelZ) / 5) + (2.5 * movPelZ) + 14.5;
				if (movPelY > 6.3 && movPelZ < 0) //	Si se llego al punto máximo en Y y minimo en Z 
				{
			...
			{
				rotPel = -90;
				movPelY -= 0.4f;	//	Disminuye la distancia de la pelota en el eje Y
			...
			if (recorrido4)
			{
				...
				rotPel = -180;
				movPelZ += 0.4f;	//	Aumenta la distancia de la pelota en el eje Z
